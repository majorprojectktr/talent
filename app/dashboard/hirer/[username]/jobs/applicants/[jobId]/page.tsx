...
import { ApplicantsDashboard } from "./_componets/applicants-dashboard";
  ...
  return (
    <div className="w-full h-fit max-w-4xl mx-auto p-4 space-y-2 border-2 rounded-xl">
      <div className="flex items-center justify-between">
        ...
        <Link href={`/dashboard/hirer/${unWrappedParams.username}/jobs`} className="capitalize cursor-pointer">
